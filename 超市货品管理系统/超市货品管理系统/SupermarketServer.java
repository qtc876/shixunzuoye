...
public class SupermarketServer {
    ...
    private static void initSampleData() {
        ...
        products.add(createProduct("P001", "Nongfu Spring Water", "Drinks", 2.5, 120, 80, 50, "Nongfu Spring Co.", now));
        products.add(createProduct("P002", "Master Kong Instant Noodles", "Instant Food", 4.5, 85, 115, 30, "Master Kong", now));
        products.add(createProduct("P003", "Yili Pure Milk", "Dairy", 6.8, 60, 90, 40, "Yili Group", now));
        products.add(createProduct("P004", "Lays Potato Chips", "Snacks", 8.9, 45, 55, 20, "PepsiCo", now));
        products.add(createProduct("P005", "Haitian Soy Sauce", "Condiments", 12.5, 8, 42, 0, "Haitian Seasoning", now));
        products.add(createProduct("P006", "Red Fuji Apple", "Fruits", 9.9, 30, 70, 25, "Yantai Apple Base", now));
        products.add(createProduct("P007", "Snow Beer", "Drinks", 5.5, 200, 150, 100, "Snow Beer Co.", now));
        products.add(createProduct("P008", "Oreo Cookies", "Snacks", 11.8, 55, 45, 30, "Mondelez", now));
    }
